...
{
    cppx::semver version(1, 2, 3, "alpha.1");
    ASSERT_EQ(version.major(), 1);
    ASSERT_EQ(version.minor(), 2);
    ASSERT_EQ(version.patch(), 3);
...
{
    cppx::semver version(1, 2, 3, "alpha.1", "specific-build");
    ASSERT_EQ(version.major(), 1);
    ASSERT_EQ(version.minor(), 2);
    ASSERT_EQ(version.patch(), 3);
    ASSERT_EQ(version.pre_release(), "alpha.1");
...
{
    cppx::numver version_core(1, 2, 3);
    cppx::semver version(version_core, "pre-release.1");
    ASSERT_EQ(version.major(), 1);
    ASSERT_EQ(version.minor(), 2);
    ASSERT_EQ(version.patch(), 3);
...
{
    cppx::numver version_core(1, 2, 3);
    cppx::semver version(version_core, "alpha.1", "specific-build");
    ASSERT_EQ(version.major(), 1);
    ASSERT_EQ(version.minor(), 2);
    ASSERT_EQ(version.patch(), 3);
    ASSERT_EQ(version.pre_release(), "alpha.1");
...
TEST(semantic_version_tests, semantic_version_constructor__x_y_z_bpr_bm__expect_exception)
{
    try
    {
        cppx::semver version(1, 2, 3, "alpha_1", "specific-build");
        FAIL();
    }
    catch (...)
    {
...
TEST(semantic_version_tests, semantic_version_constructor__x_y_z_pr_bbm__expect_exception)
{
    try
    {
        cppx::semver version(1, 2, 3, "alpha.1", "specific_build");
        FAIL();
    }
    catch (...)
    {
                          ...
                          std::string_view build_metadata = "")
{
    ...
    cppx::semver semver(version_strv);
...
TEST(semantic_version_tests, semantic_version_constructor__bad_sv__expect_exception)
{
    try
    {
        cppx::semver version_1("0.1.2-alpha_0+specific-build");
        FAIL();
    }
    catch (const std::exception&)
    {
    ...
    try
    {
        cppx::semver version_2("0.1.2-alpha-0+specific_build");
        FAIL();
    }
    catch (const std::exception&)
    {
    ...
    try
    {
        cppx::semver version_3("0.1.2-alpha.bad_item+item.specific_build");
        FAIL();
    }
    catch (const std::exception&)
    {
    ...
    try
    {
        cppx::semver version_4("0.1.2-alpha-0+item.specific_build");
        FAIL();
    }
    catch (const std::exception&)
    {
...
{
    cppx::semver version(0, 1, 2);
    ASSERT_EQ(version.core(), cppx::numver(0, 1, 2));
    const cppx::semver c_version(0, 1, 2);
    ASSERT_EQ(c_version.core(), cppx::numver(0, 1, 2));
}

TEST(semantic_version_tests, operator_eq__normal__no_exception)
{
    ASSERT_EQ(cppx::semver(0, 1, 2, "alpha.1", "build-title"), cppx::semver(0, 1, 2, "alpha.1", "build-title"));
    ASSERT_EQ(cppx::semver(0, 1, 2, "alpha.1", "build-title"), cppx::semver(0, 1, 2, "alpha.1"));
    ASSERT_EQ(cppx::semver(0, 1, 2, "alpha.1", "build-title"), cppx::semver("0.1.2-alpha.1+build-title"));
    ASSERT_EQ(cppx::semver(0, 1, 2, "alpha.1", "build-title"), cppx::semver("0.1.2-alpha.1"));
}
...
{
    ASSERT_NE(cppx::semver(0, 1, 2, "alpha.1", "build-title"), cppx::semver(0, 1, 2, "alpha.2", "build-title"));
    ASSERT_NE(cppx::semver(0, 1, 3, "alpha.1", "build-title"), cppx::semver(0, 1, 2, "alpha.1", "build-title"));
}

TEST(semantic_version_tests, operator_lt__normal__no_exception)
{
    EXPECT_TRUE(cppx::semver("1.2.3") < cppx::semver("1.2.4"));
    EXPECT_TRUE(cppx::semver("1.2.3-1234") < cppx::semver("1.2.3-123a"));
    EXPECT_TRUE(cppx::semver("1.2.3-alpha.99") < cppx::semver("1.2.3-alpha.00a"));
    EXPECT_TRUE(cppx::semver("1.2.3-alpha.9999") < cppx::semver("1.2.3-alpha.00a"));
    EXPECT_TRUE(cppx::semver("1.2.3-alpha.7") < cppx::semver("1.2.3-alpha.22"));
    EXPECT_TRUE(cppx::semver("1.2.3-alpha.7") < cppx::semver("1.2.3-alpha.77"));
    EXPECT_TRUE(cppx::semver("1.2.3-alpha.1") < cppx::semver("1.2.3-alpha.-v"));
    EXPECT_TRUE(cppx::semver("1.2.3-1.4") < cppx::semver("1.2.3-alpha.2"));
    EXPECT_TRUE(cppx::semver("1.2.3-alpha.beta.4") < cppx::semver("1.2.3-alpha.gamma.2"));
    EXPECT_TRUE(cppx::semver("1.2.3-1456") < cppx::semver("1.2.3--lol"));
    EXPECT_TRUE(cppx::semver("1.2.3-1456") < cppx::semver("1.2.3-1456.123"));
    cppx::semver va("1.2.3-045a");
    cppx::semver vb("1.2.3-145a");
    EXPECT_TRUE(va < vb);

    EXPECT_FALSE(cppx::semver("1.2.3-alpha.22") < cppx::semver("1.2.3-alpha.7"));
    EXPECT_FALSE(cppx::semver("1.2.3-alpha.77") < cppx::semver("1.2.3-alpha.7"));
    EXPECT_FALSE(cppx::semver("1.2.3-1456.123") < cppx::semver("1.2.3-1456.123"));
    EXPECT_FALSE(cppx::semver("1.2.3--lol") < cppx::semver("1.2.3-1456"));
    EXPECT_FALSE(cppx::semver("1.2.3-alpha.gamma") < cppx::semver("1.2.3-alpha.beta"));
    EXPECT_FALSE(cppx::semver("1.2.3-alpha.beta") < cppx::semver("1.2.3-alpha"));
    EXPECT_FALSE(cppx::semver("1.2.3-alpha.7") < cppx::semver("1.2.3-alpha.6"));
    EXPECT_FALSE(cppx::semver("1.2.3") < cppx::semver("1.2.3-alpha.6"));
}

TEST(semantic_version_tests, operator_le__normal__no_exception)
{
    ASSERT_TRUE(cppx::semver("1.2.3") <= cppx::semver("1.2.3"));
    ASSERT_TRUE(cppx::semver("1.2.3") <= cppx::semver("1.2.4"));
    ASSERT_TRUE(cppx::semver("1.2.3-alpha.1") <= cppx::semver("1.2.3-alpha.2"));
    ASSERT_TRUE(cppx::semver("1.2.3-1.4") <= cppx::semver("1.2.3-alpha.2"));
    ASSERT_TRUE(cppx::semver("1.2.3-alpha.beta.4") <= cppx::semver("1.2.3-alpha.gamma.2"));
    ASSERT_TRUE(cppx::semver("1.2.3-1456") <= cppx::semver("1.2.3--lol"));
    ASSERT_TRUE(cppx::semver("1.2.3-1456") <= cppx::semver("1.2.3-1456.123"));
}

TEST(semantic_version_tests, operator_gt__normal__no_exception)
{
    ASSERT_TRUE(cppx::semver("1.2.3--lol") > cppx::semver("1.2.3-1456"));
    ASSERT_TRUE(cppx::semver("1.2.3-alpha.gamma") > cppx::semver("1.2.3-alpha.beta"));
    ASSERT_TRUE(cppx::semver("1.2.3-alpha.beta") > cppx::semver("1.2.3-alpha"));
    ASSERT_TRUE(cppx::semver("1.2.3-alpha.7") > cppx::semver("1.2.3-alpha.6"));
    ASSERT_TRUE(cppx::semver("1.2.3") > cppx::semver("1.2.3-alpha.6"));

    ASSERT_FALSE(cppx::semver("1.2.3-1456.123") > cppx::semver("1.2.3-1456.123"));
    ASSERT_FALSE(cppx::semver("1.2.3") > cppx::semver("1.2.4"));
    ASSERT_FALSE(cppx::semver("1.2.3-alpha.1") > cppx::semver("1.2.3-alpha.2"));
    ASSERT_FALSE(cppx::semver("1.2.3-1.4") > cppx::semver("1.2.3-alpha.2"));
    ASSERT_FALSE(cppx::semver("1.2.3-alpha.beta.4") > cppx::semver("1.2.3-alpha.gamma.2"));
    ASSERT_FALSE(cppx::semver("1.2.3-1456") > cppx::semver("1.2.3--lol"));
    ASSERT_FALSE(cppx::semver("1.2.3-1456") > cppx::semver("1.2.3-1456.123"));
}
...
{
    static constexpr cppx::semver version_1(0, 1, 2, "0.0", "specific-build");
    ...
    static constexpr cppx::semver version_2("98.7.66-0.0+specific-build");
...
{
    const cppx::semver version(1, 2, 3, "alpha.1", "specific-build");
...
{
    const cppx::semver version(1, 2, 3, "alpha.1");
    const std::string version_str = std::format("{}", version);
...
{
    const cppx::semver version(1, 2, 3, "", "specific-build");
    const std::string version_str = std::format("{}", version);
