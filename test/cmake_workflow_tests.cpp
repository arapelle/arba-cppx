...
TEST(cmake_workflow_tests, configure__ok)
{
...
TEST(cmake_workflow_tests, build__ok)
{
    const int res = cmake.build(BUILD_DIR);
    ASSERT_EQ(res, 0);
}

TEST(cmake_workflow_tests, test__ok)
{
...
TEST(cmake_workflow_tests, install__ok)
{
    const int res = cmake.install(BUILD_DIR);
    ASSERT_EQ(res, 0);
}

TEST(cmake_workflow_tests, test_package__ok)
{
...
TEST(cmake_workflow_tests, uninstall__ok)
{
