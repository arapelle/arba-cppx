#include <arba/cppx/macro/identity_type.hpp>

#include <gtest/gtest.h>

#include <format>

#define ARBA_DEFINE_TYPE(using_type, type) using using_type = ARBA_CPPX_IDENTITY_TYPE(type)

#define DEFINE_TYPE(using_type, type) using using_type = CPPX_IDENTITY_TYPE(type)
